---
description: A condensed, test-first 6-step debugging workflow that preserves the original plan’s rigor: define a tight bug boundary, map only the execution path, generate testable hypotheses, validate them with targeted tests
---
